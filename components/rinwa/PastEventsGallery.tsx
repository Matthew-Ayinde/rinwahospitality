 ...
 * Now fetches from API with fallback to empty state.
 */
      ...
      <div className="mx-auto max-w-7xl">
        ...
        {isLoading ? (
          <div className="mt-10 grid auto-rows-[220px] gap-4 sm:auto-rows-[240px] md:grid-cols-2 xl:grid-cols-4">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="animate-pulse rounded-[1.8rem] border border-white/10 bg-white/5" />
            ))}
          </div>
        ) : events.length === 0 ? (
          <div className="mt-10 text-center text-white/45">
