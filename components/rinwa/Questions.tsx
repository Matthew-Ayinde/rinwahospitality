  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-24 text-center">
      ...
      >
        ...
        <Link
          href="/"
          className="mt-6 text-[0.65rem] uppercase tracking-[0.3em] text-white/30 hover:text-white/60 transition-colors"
        >
          ← Back to Homepage
        </Link>
      </motion.div>
    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-24 text-center">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <Link
            href="/"
            className="mt-2 text-[0.65rem] uppercase tracking-[0.3em] text-white/30 hover:text-white/60 transition-colors"
          >
            ← Return to Homepage
          </Link>
        </div>
